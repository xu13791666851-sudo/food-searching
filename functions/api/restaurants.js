...
function defaultTargetTerms(value) {
  return genericTargetTerms(value);
}

function genericTargetTerms(value) {
  const text = String(value || "");
  const rules = [
    {
      pattern: /日料|日本料理|寿司|刺身|鳗鱼|烧鸟|豚骨|拉面/i,
      terms: ["日料", "日本料理", "寿司", "日式", "和食", "居酒屋"],
    },
    {
      pattern: /韩餐|韩国料理|韩式|部队锅|石锅|拌饭|泡菜|烤肉/i,
      terms: ["韩餐", "韩国料理", "韩式", "石锅拌饭", "烤肉"],
    },
    {
      pattern: /泰餐|泰国|咖喱|冬阴功|越南粉|河粉|东南亚/i,
      terms: ["东南亚菜", "泰餐", "越南粉", "咖喱", "简餐"],
    },
    {
      pattern: /鸡腿饭|鸡排饭|鸡肉饭|猪脚饭|卤肉饭|盖饭|盖浇|便当|黄焖鸡|煲仔|海南鸡饭|石锅拌饭|饭|套餐/i,
      terms: ["盖饭", "快餐", "简餐", "便当", "沙县", "黄焖鸡", "小吃", "食堂"],
    },
    {
      pattern: /牛肉粉|牛肉面|米粉|米线|螺蛳粉|河粉|粉|面|拉面|拌面|刀削面|重庆小面|热干面/i,
      terms: ["面馆", "米粉", "米线", "粉面", "小吃", "兰州拉面"],
    },
    {
      pattern: /饺子|水饺|馄饨|云吞|抄手|锅贴|小笼包|包子|烧麦/i,
      terms: ["饺子", "馄饨", "小吃", "面馆", "包子"],
    },
    {
      pattern: /粥|汤|砂锅|汤饭|米线|麻辣烫|冒菜|关东煮|煲/i,
      terms: ["粥店", "砂锅", "汤饭", "麻辣烫", "冒菜", "小吃"],
    },
    {
      pattern: /炒|煎|烧|炖|蒸|红烧|鱼香|宫保|番茄|土豆|茄子|豆腐|青椒|回锅|家常/i,
      terms: ["家常菜", "中餐", "小炒", "快餐", "简餐"],
    },
    {
      pattern: /酸菜鱼|烤鱼|水煮鱼|鱼|虾|海鲜|小龙虾|蟹|蛙/i,
      terms: ["鱼", "海鲜", "酸菜鱼", "烤鱼", "中餐", "小吃"],
    },
    {
      pattern: /烧烤|烤串|烤肉|串串|炸串|烤鸭|烧腊/i,
      terms: ["烧烤", "烤肉", "烤串", "串串", "烧腊"],
    },
    {
      pattern: /火锅|涮锅|肥牛|毛肚|锅底/i,
      terms: ["火锅", "涮锅", "串串", "冒菜"],
    },
    {
      pattern: /麻辣烫|冒菜|钵钵鸡|串串|关东煮/i,
      terms: ["麻辣烫", "冒菜", "串串", "小吃"],
    },
    {
      pattern: /炸鸡|鸡排|鸡翅|鸡腿(?!饭)|汉堡|披萨|薯条|塔斯汀|华莱士|肯德基|麦当劳/i,
      terms: ["炸鸡", "鸡排", "汉堡", "披萨", "快餐"],
    },
    {
      pattern: /西餐|法餐|意面|牛排|鹅肝|披萨|沙拉/i,
      terms: ["西餐", "法餐", "牛排", "意面", "披萨"],
    },
    {
      pattern: /轻食|沙拉|健康餐|健身餐|鸡胸|低脂|低卡|减脂|高蛋白/i,
      terms: ["轻食", "沙拉", "健康餐", "健身餐", "简餐"],
    },
    {
      pattern: /甜品|奶茶|咖啡|蛋糕|面包|饮品|冰淇淋/i,
      terms: ["甜品", "奶茶", "咖啡", "蛋糕", "面包"],
    },
    {
      pattern: /鸡|鸭|鹅|牛|猪|肉|蛋|肝/i,
      terms: ["中餐", "快餐", "简餐", "小吃", "家常菜"],
    },
  ];
